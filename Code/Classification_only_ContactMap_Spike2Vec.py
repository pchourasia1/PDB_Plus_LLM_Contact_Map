...
#seq_data_2 = np.load(data_path + "Spike2Vec_PDB_Bind_3792_seq_k_3" + ".npy",allow_pickle=True)
...
seq_data_2 = np.load(data_path + "Spike2Vec_PDB_stcrdab_480_seq_k_3" + ".npy",allow_pickle=True)

seq_data = []
for i in range(len(seq_data_1)):
    seq_data.append(np.concatenate((seq_data_1[i],seq_data_2[i]),axis=0))
