...
##########################################################################
data_path = "/alina-data1/sarwan/PDB_Contact_Map/Dataset/PdbBind/"

data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_0.npy",allow_pickle=True)
seq_data = []
for i in range(len(data_1)):
    seq_data.append(data_1[i])

data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_200.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_400.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_600.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_800.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_1000.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_1200.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_1400.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_1600.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_1800.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_2000.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_2200.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_2400.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_2600.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_2800.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_3000.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_3200.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_3400.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_3600.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_3792_sequences_final.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
 
seq_data = np.array(seq_data) 
print("Total input sequences: ",len(seq_data))




attribute_data = np.load(data_path + "PDBBind_attribute_names_3792.npy")
...
# Find the minimum row size
min_size = min(len(row) for row in arr)

# Create a new array with zeros and copy the data
#new_arr = np.zeros((arr.shape[0], max_size), dtype=arr.dtype)
new_arr = np.zeros((arr.shape[0], min_size), dtype=arr.dtype)

for i, row in enumerate(arr):
    #new_arr[i, :len(row)] = row
    if len(row)>min_size:
        new_arr[i, :min_size] = row[0:min_size]
    elif len(row)<=min_size:
        new_arr[i, :len(row)] = row
...
np.save(data_path + "SeqVec_Embedding_3792_sequences_STCRDAB_PdbBind_Embeddings.npy",seq_data)
# ##########################################################
