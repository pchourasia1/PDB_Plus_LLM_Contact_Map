...
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_0.npy",allow_pickle=True)
seq_data = []
for i in range(len(data_1)):
    seq_data.append(data_1[i])

data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_50.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_100.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_150.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_200.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_250.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_300.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_350.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_400.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_450.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
    
data_1 = np.load(data_path + "SeqVec_Embedding_480_sequences_final.npy",allow_pickle=True)
for i in range(len(data_1)):
    seq_data.append(data_1[i])
...
np.save(data_path + "SeqVec_Embedding_480_sequences_STCRDAB_PCA_Embeddings.npy",seq_data)
# ##########################################################
