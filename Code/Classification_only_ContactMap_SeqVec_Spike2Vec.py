...
seq_data_1 = np.load(data_path + "PDBBind_Contact_Map_PCA_Embeddings_2105_x_3792" + ".npy",allow_pickle=True)
seq_data_2 = np.load(data_path + "SeqVec_Embedding_3792_sequences_PdbBind_Embeddings" + ".npy",allow_pickle=True)
seq_data_3 = np.load(data_path + "Spike2Vec_PDB_Bind_3792_seq_k_3" + ".npy",allow_pickle=True)


#data_path = "/alina-data1/sarwan/PDB_Contact_Map/Dataset/STCRDAB/"
#seq_data_1 = np.load(data_path + "STCRDAB_Contact_Map_PCA_Embeddings_480_seq" + ".npy",allow_pickle=True)
#seq_data_2 = np.load(data_path + "SeqVec_Embedding_480_sequences_STCRDAB_PCA_Embeddings" + ".npy",allow_pickle=True)
#seq_data_3 = np.load(data_path + "Spike2Vec_PDB_stcrdab_480_seq_k_3" + ".npy",allow_pickle=True)

seq_data = []
for i in range(len(seq_data_1)):
    seq_data.append(np.concatenate((seq_data_1[i],seq_data_2[i],seq_data_3[i]),axis=0))
...
arr_2d_pca = np.array(pca.fit_transform(np.array(seq_data)))
...
print("Final Data Shape: ",np.array(seq_data).shape)
