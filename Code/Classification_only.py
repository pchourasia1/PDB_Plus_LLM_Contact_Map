...
##########################################################################
data_path = "/alina-data1/sarwan/PDB_Contact_Map/Dataset/"

data_name = "PDBBind_Contact_Map_Unaligned_Embeddings_3792"
...
new_arr1 = np.zeros((arr.shape[0], max_size), dtype=arr.dtype)
for i, row in enumerate(arr):
    new_arr1[i, :len(row)] = row
...
np.save(data_path + "PDBBind_Contact_Map_PCA_Embeddings_" + str(len(seq_data[0])) + "_x_3792.npy",seq_data)
# ##########################################################
